...
export const changePassword = (data) =>
  request.post(`${baseUrl}/auth/changePassword`, data);
...
export const getSingleProduct = (id) =>
  axios.get(`${baseUrl}/products/get/${id}`);

// add to cart
export const addToCart = (data) =>
  request.post(`${baseUrl}/products/addCart`, data);
...
export const deleteCartItem = (id) =>
  request.delete(`${baseUrl}/products/addCartRemove/${id}`);
...
export const createUserAddress = (data) =>
  request.post(`${baseUrl}/address/addAddress`, data);

// make address default
export const setDefaultAddress = (data) =>
  request.put(`${baseUrl}/address/setAddressDefault`, data);
...
export const updateUserProfile = (data) =>
  request.put(`${baseUrl}/user/update-profile`, data);

// create order
export const createOrder = (data) =>
  request.post(`${baseUrl}/orders/create-order`, data);

// payment verification
export const verifyPayment = (data) =>
  request.post(`${baseUrl}/orders/verify-payment`, data);
...
export const getOrderDetailsById = (id) =>
  request.get(`${baseUrl}/orders/getOne-order/${id}`);
